...
export const SIDEBAR_HEADER_ICON_BUTTON_CLASS =
  "icon-click-feedback inline-flex h-8 w-8 shrink-0 items-center justify-center rounded-md text-[var(--app-hint)] transition-colors hover:bg-[var(--app-bg)] hover:text-[var(--app-fg)] disabled:opacity-40";

export const SIDEBAR_HEADER_ICON_SIZE = 20;
...
export const HEADER_RESPONSIVE_TEXT_BUTTON_CLASS =
  "icon-click-feedback rah-stable-border inline-flex h-8 w-8 min-[900px]:w-auto items-center justify-center rounded-md border border-transparent px-0 min-[900px]:px-2 text-xs text-[var(--app-hint)] transition-colors hover:bg-[var(--app-subtle-bg)] hover:text-[var(--app-fg)] disabled:opacity-40";
