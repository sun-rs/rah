...
describe("translateCodexAppServerNotification", () => {
  ...
  test("maps or deliberately ignores every known Codex app-server notification method without invalid fallback", () => {
    ...
    const samples: Record<(typeof CODEX_APP_SERVER_NOTIFICATION_METHODS)[number], { method: string; params?: unknown }> = {
      ...
      "thread/settings/updated": { method: "thread/settings/updated", params: { threadId: "thread-1" } },
      ...
      "process/outputDelta": { method: "process/outputDelta", params: { processId: "proc-1", stream: "stdout", deltaBase64: b64, capReached: false } },
      "process/exited": { method: "process/exited", params: { processId: "proc-1", exitCode: 0 } },
      ...
      "item/fileChange/patchUpdated": { method: "item/fileChange/patchUpdated", params: { threadId: "thread-1", turnId: "turn-1", itemId: "patch-1", patch: "*** Begin Patch\n*** End Patch" } },
