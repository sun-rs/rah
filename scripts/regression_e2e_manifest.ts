...
const cases: RegressionCase[] = [
  ...
  },
  {
    ...
    providers: ["all"],
    automation: ["unit", "fake_browser"],
    title: "The iOS PWA New task composer keeps a readable workspace pill",
    acceptance: [
      "Standalone iOS/PWA mode never collapses the selected workspace to an icon-only control.",
      "The compact workspace pill remains 5.5rem wide and scrolls labels longer than six characters with the shared marquee.",
      "The pill does not overlap Start session or create horizontal document overflow at a 390px viewport.",
    ],
    evidence: [
      "packages/client-web/src/composer-contract.test.ts",
      "scripts/workspace_lifecycle_browser_smoke.py",
  ...
  },
  {
    ...
    acceptance: [
      "PWA user, process, and final-answer copy use a 16px font on a 24px line grid while desktop remains on 14px/22px.",
